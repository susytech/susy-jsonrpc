...
//!
//! Enables creation of "Service" objects grouping a set of RPC methods togsophy in a typed manner.
//!
//! Example
//!
//! ```
//! extern crate susy_jsonrpc_core;
//! #[macro_use] extern crate susy_jsonrpc_macros;
...
pub extern crate susy_jsonrpc_pubsub;
extern crate serde;
